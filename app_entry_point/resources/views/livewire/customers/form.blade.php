  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="storeCustomerData" id="cust-form" method="POST" >
                    @csrf
                    <div class="row">
                        <div class="mx-auto col-md-12 col-lg-12 col-xl-12 d-block ml">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input
                                    wire:model.lazy="contact_person" id="contact_person" name="contact_person" type="text"
                    ...
                    <div class="mt-4 modal-footer">
                        <button class="btn btn-indigo" type="submit"
                            wire:submit="storeCustomerData">Save changes</button>
