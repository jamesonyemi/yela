...
<div class="p-16 m-10 mx-auto bg-blue-100 sm:p-24 lg:p-48">

    <!-- Carousel Body -->
    <div class="relative items-center block bg-gray-100 rounded-lg shadow-xl md:flex" style="min-height: 19rem;">
      <div class="relative w-full h-full overflow-hidden rounded-t-lg md:w-2/5 md:rounded-t-none md:rounded-l-lg" style="min-height: 19rem;">
        <img class="absolute inset-0 object-cover object-center w-full h-full" src="https://stripe.com/img/v3/payments/overview/photos/missguided.jpg" alt="">
        <div class="absolute inset-0 w-full h-full bg-indigo-900 opacity-75"></div>
        <div class="absolute inset-0 flex items-center justify-center w-full h-full text-white fill-current">
      ...
      <div class="flex items-center w-full h-full bg-gray-100 rounded-lg md:w-3/5">
        <div class="p-12 md:pr-24 md:pl-16 md:py-12">
          <p class="text-gray-600"><span class="text-gray-900">Missguided</span> is a UK-based fashion retailer that has nearly doubled in size since last year. They integrated Stripe to deliver seamless checkout across mobile and web for vehicles in 100+ countries, all while automatically combating fraud.</p>
          <a class="flex items-baseline mt-3 text-indigo-600 hover:text-indigo-900 focus:text-indigo-900" href="">
            <span>Learn more about this Vehicle</span>
            <span class="ml-1 text-xs">&#x279c;</span>
          </a>
        </div>
        <svg class="absolute inset-y-0 hidden w-24 h-full -ml-12 text-gray-100 fill-current md:block" viewBox="0 0 100 100" preserveAspectRatio="none">
    ...
    <!-- Carousel Tabs -->
    <div class="flex items-center justify-between float-right mt-5 sm:justify-center ">
      <div class="m-1 space-x-3 space-y-1">
        <button
